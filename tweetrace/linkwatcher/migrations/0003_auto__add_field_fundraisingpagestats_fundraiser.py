...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FundRaisingPageStats.fundraiser'
        db.add_column('linkwatcher_fundraisingpagestats', 'fundraiser', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['justgivingbadges.FundRaiserProfile'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FundRaisingPageStats.fundraiser'
        db.delete_column('linkwatcher_fundraisingpagestats', 'fundraiser_id')
    ...
    models = {
        ...
        'linkwatcher.fundraisingpagestats': {
            ...
            'fundraiser': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['justgivingbadges.FundRaiserProfile']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
