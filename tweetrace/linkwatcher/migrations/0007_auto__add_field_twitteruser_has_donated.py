...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TwitterUser.has_donated'
        db.add_column('linkwatcher_twitteruser', 'has_donated', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TwitterUser.has_donated'
        db.delete_column('linkwatcher_twitteruser', 'has_donated')
