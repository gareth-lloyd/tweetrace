...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'FundRaisingPageStats.page_name'
        db.delete_column('linkwatcher_fundraisingpagestats', 'page_name')


    def backwards(self, orm):
        
        # Adding field 'FundRaisingPageStats.page_name'
        db.add_column('linkwatcher_fundraisingpagestats', 'page_name', self.gf('django.db.models.fields.CharField')(default=None, max_length=255, unique=True), keep_default=False)
