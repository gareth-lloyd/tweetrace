...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Mention.link' to match new field type.
        db.rename_column('linkwatcher_mention', 'link', 'link_id')
        # Changing field 'Mention.link'
        db.alter_column('linkwatcher_mention', 'link_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['justgivingbadges.FundRaiserProfile']))

        # Adding index on 'Mention', fields ['link']
        db.create_index('linkwatcher_mention', ['link_id'])


    def backwards(self, orm):
        
        # Removing index on 'Mention', fields ['link']
        db.delete_index('linkwatcher_mention', ['link_id'])

        # Renaming column for 'Mention.link' to match new field type.
        db.rename_column('linkwatcher_mention', 'link_id', 'link')
        # Changing field 'Mention.link'
        db.alter_column('linkwatcher_mention', 'link', self.gf('django.db.models.fields.CharField')(max_length=300))
