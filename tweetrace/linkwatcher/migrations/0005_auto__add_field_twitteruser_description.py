...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TwitterUser.description'
        db.add_column('linkwatcher_twitteruser', 'description', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TwitterUser.description'
        db.delete_column('linkwatcher_twitteruser', 'description')
    ...
    models = {
        ...
        'justgivingbadges.fundraiserprofile': {
            ...
            'page_id': ('django.db.models.fields.CharField', [], {'max_length': '200', 'primary_key': 'True'}),
