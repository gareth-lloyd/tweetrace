...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FundRaiserProfile.user'
        db.alter_column('justgivingbadges_fundraiserprofile', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True, null=True))


    def backwards(self, orm):
        
        # Changing field 'FundRaiserProfile.user'
        db.alter_column('justgivingbadges_fundraiserprofile', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(default=None, to=orm['auth.User'], unique=True))
