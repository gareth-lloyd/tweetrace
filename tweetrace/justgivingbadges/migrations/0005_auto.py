...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'FundRaiserProfile', fields ['page_score']
        db.create_index('justgivingbadges_fundraiserprofile', ['page_score'])


    def backwards(self, orm):
        
        # Removing index on 'FundRaiserProfile', fields ['page_score']
        db.delete_index('justgivingbadges_fundraiserprofile', ['page_score'])
