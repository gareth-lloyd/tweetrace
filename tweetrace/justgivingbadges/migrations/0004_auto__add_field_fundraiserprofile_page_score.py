...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FundRaiserProfile.page_score'
        db.add_column('justgivingbadges_fundraiserprofile', 'page_score', self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FundRaiserProfile.page_score'
        db.delete_column('justgivingbadges_fundraiserprofile', 'page_score')
    ...
    models = {
        ...
        'justgivingbadges.fundraiserprofile': {
            ...
            'page_score': ('django.db.models.fields.IntegerField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
